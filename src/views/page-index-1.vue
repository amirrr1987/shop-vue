<template>
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<article>
							...
							<div class="mt-2">
								<time class="text-muted small d-block mb-1" datetime="2022-02-14 00:00"> <i
										class="fa fa-calendar-alt"></i> 23.12.2021</time>
								<a href="#">
									<h6 class="title">How to promote brands</h6>
								</a>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<article>
							...
							<div class="mt-2">
								<time class="text-muted small d-block mb-1" datetime="2022-02-14 00:00"> <i
										class="fa fa-calendar-alt"></i> 03.09.2022</time>
								<a href="#">
									<h6 class="title">How we handle shipping</h6>
								</a>
								<p>When you enter into any new area of science, you almost reach</p>
							</div>
						</article>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<article>
							...
							<div class="mt-2">
								<time class="text-muted small d-block mb-1" datetime="2022-02-14 00:00"> <i
										class="fa fa-calendar-alt"></i> 13.12.2021</time>
								<a href="#">
									<h6 class="title">How to promote brands</h6>
								</a>
								<p>When you enter into any new area of science, you almost reach</p>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<article>
							...
							<div class="mt-2">
								<time class="text-muted small d-block mb-1" datetime="2022-02-14 00:00"> <i
										class="fa fa-calendar-alt"></i> 25.11.2022</time>
								<a href="#">
					...
					<div class="row">
						<aside class="col-12 col-sm-12 col-lg-3">
							<article class="me-lg-4">
								<img src="@/assets/images/logo.webp" class="logo-footer">
		...
		<aside class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas_cart">
			...
			<div class="offcanvas-body">
				...
				<p class="mb-3 text-center"> <img src="@/assets/images/misc/payments.webp" height="22"> </p>
