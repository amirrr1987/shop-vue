				...
				<section class="footer-main padding-y">
					<div class="row">
						...
						<aside class="col-6 col-sm-4 col-lg-2">
							...
							<a href="#" class="mb-2 d-inline-block"> <img src="@/assets/images/misc/btn-appstore.webp"
									height="38"></a>
							<a href="#" class="mb-2 d-inline-block"> <img src="@/assets/images/misc/btn-market.webp" height="38"></a>
						</aside>
					</div> <!-- row.// -->
				</section> <!-- footer-top.// -->
