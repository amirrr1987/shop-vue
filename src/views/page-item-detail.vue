      ...
      <div class="row">
          ...
          <article class="gallery-wrap">
            <div class="img-big-wrap img-thumbnail">
              <a data-fslightbox="mygalley" data-type="image" href="images/items/detail1/big.webp">
                <img height="560" src="@/assets/images/items/detail1/big.webp">
              </a>
            </div> <!-- img-big-wrap.// -->
            <div class="thumbs-wrap">
              <a data-fslightbox="mygalley" data-type="image" href="images/items/detail1/big1.webp" class="item-thumb">
                <img width="60" height="60" src="@/assets/images/items/detail1/thumb1.webp">
              </a>
              <a data-fslightbox="mygalley" data-type="image" href="images/items/detail1/big2.webp" class="item-thumb">
                <img width="60" height="60" src="@/assets/images/items/detail1/thumb2.webp">
              </a>
              <a data-fslightbox="mygalley" data-type="image" href="images/items/detail1/big3.webp" class="item-thumb">
                <img width="60" height="60" src="@/assets/images/items/detail1/thumb3.webp">
              </a>
              <a data-fslightbox="mygalley" data-type="image" href="images/items/detail1/big4.webp" class="item-thumb">
                <img width="60" height="60" src="@/assets/images/items/detail1/thumb4.webp">
              </a>
              <a data-fslightbox="mygalley" data-type="image" href="images/items/detail1/big.webp" class="item-thumb">
                <img width="60" height="60" src="@/assets/images/items/detail1/thumb.webp">
              </a>
            </div> <!-- thumbs-wrap.// -->
        ...
        <main class="col-lg-6">
          <article class="ps-lg-3">
            ...
            <p>Modern look and quality demo item is a streetwear-inspired collection that continues to break away from
          ...
          <div class="card">
            ...
            <div class="tab-content">
              <article id="tab_specs" class="tab-pane show active card-body">
                <p>With supporting text below as a natural lead-in to additional content. Lorem ipsum dolor sit amet,
        ...
        <div class="row">
          <aside class="col-12 col-sm-12 col-lg-3">
            <article class="me-lg-4">
              <img src="@/assets/images/logo-white.webp" class="logo-footer">
      ...
      <section class="footer-bottom d-flex justify-content-lg-between">
        ...
        <nav class="dropup">
          <button class="dropdown-toggle btn text-white d-flex align-items-center py-0" type="button"
            ...
            <img src="@/assets/images/flags/flag-usa.webp" class="me-2" height="20">
            <span>English</span>
          </button>
