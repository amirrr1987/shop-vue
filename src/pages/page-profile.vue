                ...
                <figure class="itemside align-items-center">
                  <div class="aside">
                    <span class="bg-gray icon-md rounded-circle">
                      <img src="@/assets/images/avatars/avatar.webp" class="icon-md rounded-circle">
                    </span>
                  </div>
                    ...
                    <ul class="row">
                      <li class="col-xl-4  col-lg-6">
                        <figure class="itemside mb-3">
                          <div class="aside">
                            <img width="72" height="72" src="@/assets/images/items/1.webp" class="img-sm rounded border">
                          </div>
                          <figcaption class="info">
                      ...
                      <li class="col-xl-4  col-lg-6">
                        <figure class="itemside mb-3">
                          <div class="aside">
                            <img width="72" height="72" src="@/assets/images/items/2.webp" class="img-sm rounded border">
                          </div>
                          <figcaption class="info">
                      ...
                      <li class="col-xl-4  col-lg-6">
                        <figure class="itemside mb-3">
                          <div class="aside">
                            <img width="72" height="72" src="@/assets/images/items/7.webp" class="img-sm rounded border">
                          </div>
                          <figcaption class="info">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="row">
                      <li class="col-xl-4  col-lg-6">
                        <figure class="itemside mb-3">
                          <div class="aside">
                            <img width="72" height="72" src="@/assets/images/items/10.webp" class="img-sm rounded border">
                          </div>
                          <figcaption class="info">
                            <p class="title">T-shirts with multiple colors</p>
                            <strong> 2x = $339.90 </strong>
                      ...
                      <li class="col-xl-4 col-lg-6">
                        <figure class="itemside mb-3">
                          <div class="aside">
                            <img width="72" height="72" src="@/assets/images/items/11.webp" class="img-sm rounded border">
                          </div>
                          <figcaption class="info">
                            <p class="title">Gaming Headset 32db Black</p>
                            <strong> 2x = $339.90 </strong>
