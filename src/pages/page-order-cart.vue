					...
					<div class="card">
						<div class="content-body">
							...
							<article class="row gy-3 mb-4">
								<div class="col-lg-5">
									<figure class="itemside me-lg-5">
										<div class="aside"><img src="@/assets/images/items/11.webp"
							...
							<article class="row gy-3 mb-4">
								<div class="col-lg-5">
									<figure class="itemside me-lg-5">
										<div class="aside"><img src="@/assets/images/items/12.webp"
												class="img-sm img-thumbnail">
										</div>
										<figcaption class="info">
							...
							<article class="row gy-3 mb-4">
								<div class="col-lg-5">
									<figure class="itemside me-lg-5">
										<div class="aside"><img src="@/assets/images/items/13.webp"
												class="img-sm img-thumbnail">
										</div>
										<figcaption class="info">
